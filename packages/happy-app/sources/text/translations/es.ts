...
export const es: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Acerca de',
        aboutFooter: 'AgenticMessenger es un cliente móvil para Codex y Claude Code. Todo está cifrado de extremo a extremo y tu cuenta se guarda solo en tu dispositivo. No está afiliado con Anthropic.',
        whatsNew: 'Novedades',
    ...
    server: {
        ...
        notValidHappyServer: 'No es un servidor AgenticMessenger válido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID de sesión de AgenticMessenger copiado al portapapeles',
        failedToCopySessionId: 'Falló al copiar ID de sesión de AgenticMessenger',
        happySessionId: 'ID de sesión de AgenticMessenger',
        ...
        happyHome: 'Directorio de AgenticMessenger',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale el AgenticMessenger CLI',
            runIt: 'Ejecútelo',
    ...
    settingsVoice: {
        ...
        byoDescription: 'Usa tu propio agente de ElevenLabs en lugar del predeterminado de AgenticMessenger. No se requiere suscripción — conéctate directamente con tu propia cuenta de ElevenLabs. Tu agente debe definir dos herramientas de cliente: messageClaudeCode (envía texto al agente de código) y processPermissionRequest (permite o deniega el uso de herramientas). Recibe el contexto de la sesión a través de la variable dinámica {{initialConversationContext}}.',
        customAgentId: 'ElevenLabs Agent ID',
        customAgentIdNotSet: 'No configurado',
        customAgentIdDescription: 'Ingresa tu ElevenLabs Agent ID. Déjalo vacío para usar el predeterminado de AgenticMessenger.',
        customAgentIdPlaceholder: 'e.g. abc123def456',
        bypassToken: 'Conexión directa',
        bypassTokenSubtitle: 'Omite el servidor de AgenticMessenger, conéctate directamente a ElevenLabs',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal está solicitando conectarse a tu cuenta de AgenticMessenger. Esto permitirá al terminal enviar y recibir mensajes de forma segura.',
