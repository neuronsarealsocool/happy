...
export const pl: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'O aplikacji',
        aboutFooter: 'Agentic Messenger to mobilny klient Codex i Claude Code. Jest w pełni szyfrowany end-to-end, a Twoje konto jest przechowywane tylko na Twoim urządzeniu. Nie jest powiązany z Anthropic.',
        whatsNew: 'Co nowego',
    ...
    server: {
        ...
        notValidHappyServer: 'To nie jest prawidłowy serwer Agentic Messenger',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID sesji Agentic Messenger skopiowane do schowka',
        failedToCopySessionId: 'Nie udało się skopiować ID sesji Agentic Messenger',
        happySessionId: 'ID sesji Agentic Messenger',
        ...
        happyHome: 'Katalog domowy Agentic Messenger',
    ...
    settingsVoice: {
        ...
        byoDescription: 'Użyj własnego agenta ElevenLabs zamiast domyślnego Agentic Messenger. Subskrypcja nie jest wymagana — połącz się bezpośrednio ze swoim kontem ElevenLabs. Twój agent musi definiować dwa narzędzia klienckie: messageClaudeCode (wysyła tekst do agenta kodującego) i processPermissionRequest (zezwala lub odmawia użycia narzędzi). Otrzymuje kontekst sesji przez zmienną dynamiczną {{initialConversationContext}}.',
        customAgentId: 'ElevenLabs Agent ID',
        customAgentIdNotSet: 'Nie skonfigurowano',
        customAgentIdDescription: 'Wprowadź swój ElevenLabs Agent ID. Pozostaw puste, aby użyć domyślnego Agentic Messenger.',
        customAgentIdPlaceholder: 'e.g. abc123def456',
        bypassToken: 'Połączenie bezpośrednie',
        bypassTokenSubtitle: 'Pomiń serwer Agentic Messenger, połącz się bezpośrednio z ElevenLabs',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Terminal żąda połączenia z Twoim kontem Agentic Messenger. Pozwoli to terminalowi bezpiecznie wysyłać i odbierać wiadomości.',
