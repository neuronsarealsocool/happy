...
export const pl: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'O aplikacji',
        aboutFooter: 'AgenticMessenger to mobilny klient Codex i Claude Code. Jest w pełni szyfrowany end-to-end, a Twoje konto jest przechowywane tylko na Twoim urządzeniu. Nie jest powiązany z Anthropic.',
        whatsNew: 'Co nowego',
    ...
    server: {
        ...
        notValidHappyServer: 'To nie jest prawidłowy serwer AgenticMessenger',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID sesji AgenticMessenger skopiowane do schowka',
        failedToCopySessionId: 'Nie udało się skopiować ID sesji AgenticMessenger',
        happySessionId: 'ID sesji AgenticMessenger',
        ...
        happyHome: 'Katalog domowy AgenticMessenger',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Zainstaluj AgenticMessenger CLI',
            runIt: 'Uruchom je',
    ...
    settingsVoice: {
        ...
        customAgentIdDescription: 'Wprowadź swój ElevenLabs Agent ID. Pozostaw puste, aby użyć domyślnego AgenticMessenger.',
        customAgentIdPlaceholder: 'e.g. abc123def456',
        bypassToken: 'Połączenie bezpośrednie',
        bypassTokenSubtitle: 'Pomiń serwer AgenticMessenger, połącz się bezpośrednio z ElevenLabs',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Terminal żąda połączenia z Twoim kontem AgenticMessenger. Pozwoli to terminalowi bezpiecznie wysyłać i odbierać wiadomości.',
