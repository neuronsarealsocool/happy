...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Sobre',
        aboutFooter: 'AgenticMessenger é um cliente móvel para Codex e Claude Code. É totalmente criptografado ponta a ponta e sua conta é armazenada apenas no seu dispositivo. Não é afiliado à Anthropic.',
        whatsNew: 'Novidades',
    ...
    server: {
        ...
        notValidHappyServer: 'Não é um servidor AgenticMessenger válido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID da sessão AgenticMessenger copiado para a área de transferência',
        failedToCopySessionId: 'Falha ao copiar ID da sessão AgenticMessenger',
        happySessionId: 'ID da sessão AgenticMessenger',
        ...
        happyHome: 'Diretório AgenticMessenger',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instale o AgenticMessenger CLI',
            runIt: 'Execute',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Um terminal está solicitando conexão à sua conta AgenticMessenger. Isso permitirá que o terminal envie e receba mensagens com segurança.',
