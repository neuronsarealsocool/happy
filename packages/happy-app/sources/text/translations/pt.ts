...
export const pt: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Sobre',
        aboutFooter: 'Agentic Messenger é um cliente móvel para Codex e Claude Code. É totalmente criptografado ponta a ponta e sua conta é armazenada apenas no seu dispositivo. Não é afiliado à Anthropic.',
        whatsNew: 'Novidades',
    ...
    server: {
        ...
        notValidHappyServer: 'Não é um servidor Agentic Messenger válido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID da sessão Agentic Messenger copiado para a área de transferência',
        failedToCopySessionId: 'Falha ao copiar ID da sessão Agentic Messenger',
        happySessionId: 'ID da sessão Agentic Messenger',
        ...
        happyHome: 'Diretório Agentic Messenger',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Um terminal está solicitando conexão à sua conta Agentic Messenger. Isso permitirá que o terminal envie e receba mensagens com segurança.',
