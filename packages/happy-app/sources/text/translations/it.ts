...
export const it: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Informazioni',
        aboutFooter: 'AgenticMessenger è un client mobile per Codex e Claude Code. È completamente cifrato end-to-end e il tuo account è memorizzato solo sul tuo dispositivo. Non affiliato con Anthropic.',
        whatsNew: 'Novità',
    ...
    server: {
        ...
        notValidHappyServer: 'Non è un AgenticMessenger Server valido',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID sessione AgenticMessenger copiato negli appunti',
        failedToCopySessionId: 'Impossibile copiare l\'ID sessione AgenticMessenger',
        happySessionId: 'ID sessione AgenticMessenger',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Installa la CLI AgenticMessenger',
            runIt: 'Avviala',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminale richiede di connettersi al tuo account AgenticMessenger. Questo consentirà al terminale di inviare e ricevere messaggi in modo sicuro.',
