...
export const en: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'About',
        aboutFooter: 'Agentic Messenger is a Codex and Claude Code mobile client. It\'s fully end-to-end encrypted and your account is stored only on your device. Not affiliated with Anthropic.',
        whatsNew: 'What\'s New',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'Agentic Messenger Session ID copied to clipboard',
        failedToCopySessionId: 'Failed to copy Agentic Messenger Session ID',
        happySessionId: 'Agentic Messenger Session ID',
        ...
        happyHome: 'Agentic Messenger Home',
    ...
    sidebar: {
        sessionsTitle: 'Agentic Messenger',
    ...
    settingsVoice: {
        ...
        byoDescription: 'Use your own ElevenLabs agent instead of the Agentic Messenger default. No subscription required — connect directly with your own ElevenLabs account. Your agent must define two client tools: messageClaudeCode (sends text to the coding agent) and processPermissionRequest (allows or denies tool use). It receives session context via the {{initialConversationContext}} dynamic variable.',
        customAgentId: 'ElevenLabs Agent ID',
        customAgentIdNotSet: 'Not configured',
        customAgentIdDescription: 'Enter your ElevenLabs agent ID. Leave empty to use the Agentic Messenger default.',
        customAgentIdPlaceholder: 'e.g. abc123def456',
        bypassToken: 'Direct Connection',
        bypassTokenSubtitle: 'Skip Agentic Messenger server, connect straight to ElevenLabs',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'A terminal is requesting to connect to your Agentic Messenger account. This will allow the terminal to send and receive messages securely.',
