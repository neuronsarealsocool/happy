...
export const ca: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Quant a',
        aboutFooter: 'AgenticMessenger és un client mòbil de Codex i Claude Code. Tot està xifrat punt a punt i el teu compte es guarda només al teu dispositiu. No està afiliat amb Anthropic.',
        whatsNew: 'Novetats',
    ...
    server: {
        ...
        notValidHappyServer: 'No és un servidor AgenticMessenger vàlid',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID de la sessió de AgenticMessenger copiat al porta-retalls',
        failedToCopySessionId: 'Ha fallat copiar l\'ID de la sessió de AgenticMessenger',
        happySessionId: 'ID de la sessió de AgenticMessenger',
        ...
        happyHome: 'Directori de AgenticMessenger',
    ...
    components: {
        emptyMainScreen: {
            ...
            installCli: 'Instal·la el AgenticMessenger CLI',
            runIt: 'Executa\'l',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal està sol·licitant connectar-se al teu compte de AgenticMessenger. Això permetrà al terminal enviar i rebre missatges de forma segura.',
