...
export const ca: TranslationStructure = {
    ...
    settings: {
        ...
        about: 'Quant a',
        aboutFooter: 'Agentic Messenger és un client mòbil de Codex i Claude Code. Tot està xifrat punt a punt i el teu compte es guarda només al teu dispositiu. No està afiliat amb Anthropic.',
        whatsNew: 'Novetats',
    ...
    server: {
        ...
        notValidHappyServer: 'No és un servidor Agentic Messenger vàlid',
    ...
    sessionInfo: {
        ...
        happySessionIdCopied: 'ID de la sessió de Agentic Messenger copiat al porta-retalls',
        failedToCopySessionId: 'Ha fallat copiar l\'ID de la sessió de Agentic Messenger',
        happySessionId: 'ID de la sessió de Agentic Messenger',
        ...
        happyHome: 'Directori de Agentic Messenger',
    ...
    terminal: {
        ...
        terminalRequestDescription: 'Un terminal està sol·licitant connectar-se al teu compte de Agentic Messenger. Això permetrà al terminal enviar i rebre missatges de forma segura.',
