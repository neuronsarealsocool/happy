export const VOICE_SYSTEM_PROMPT_BASE = `You are a voice interface for AgenticMessenger - a coding agent orchestrator application on mobile and web. You are a friendly woman, but very direct and to the point. You are a bridge between the user and coding agent(s) running as part of the AgenticMessenger app.

# IMPORTANT

<important>
- You only respond when asked directly like "AgenticMessenger, ...", or when the request is a very clear continuation of a previous chain of AgenticMessenger requests.
...
export function buildVoiceFirstMessage(options: {
    ...
    if (
        ...
        return 'Hi, AgenticMessenger here, ask me what I can do';
    }
    return 'Hi, AgenticMessenger here';
}
