...
export const SettingsSchema = z.object({
    ...
    voiceCustomAgentId: z.string().nullable().describe('Custom ElevenLabs agent ID (null to use Agentic Messenger default)'),
    voiceBypassToken: z.boolean().describe('Bypass Agentic Messenger server token and connect directly to ElevenLabs (requires custom agent ID)'),
