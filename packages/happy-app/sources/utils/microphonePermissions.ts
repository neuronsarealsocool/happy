...
export function showMicrophonePermissionDeniedAlert(canAskAgain: boolean = false) {
  ...
  const message = canAskAgain
    ? 'Agentic Messenger needs access to your microphone for voice chat. Please grant permission when prompted.'
    : 'Agentic Messenger needs access to your microphone for voice chat. Please enable microphone access in your device settings.';
