...
export function useImagePicker(): UseImagePickerResult {
    ...
    /**
     * Attaches the image on the clipboard through the same normalization path
     * used by the image picker.
     */
    ...
    return { selectedImages, pickImages, pickFiles, pasteImages, attachImages, removeImage, clearImages, addImages };
}
