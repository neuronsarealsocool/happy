        ...
        <View style={styles.chatSurface}>
            ...
            {showScrollButton && (
                <View style={[
                    ...
                    >
                        <Octicons name="arrow-down" size={14} color={theme.colors.button?.primary?.tint ?? theme.colors.text} />
                    </Pressable>
                </View>
            )}
        </View>
...
const styles = StyleSheet.create((theme) => ({
    ...
    scrollButtonDefault: {
        backgroundColor: theme.colors.button?.primary?.background ?? theme.colors.surface,
        opacity: 0.94,
    },
    scrollButtonPressed: {
        backgroundColor: theme.colors.button?.primary?.background ?? theme.colors.surface,
