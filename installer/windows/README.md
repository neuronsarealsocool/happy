...
- Adds a Startup shortcut that launches the tray controller through hidden PowerShell, starts the Happy daemon hidden, retries if it is not running, and does not show a command prompt when Windows signs in.
